...
*(qua lo screenshot del Senato, il sito non va)*
...
Questo sistema è facilmente aggirabile semplicemente affidandosi a un altro **servizio DNS pubblico**, ad esempio quelli di Google e di Cloudflare, che non applicano blocchi. Per questo motivo la legge antipirateria prevede che si possano **bloccare anche gli indirizzi IP direttamente**.
...
Nella nuova versione della legge **la parola «univocamente» è stata sostituita da «prevalentemente»**: significa che ora **si potranno bloccare anche indirizzi IP** che non sono dedicati alla diffusione di contenuti illegali ma **che ospitano anche altri contenuti legittimi**.
...
Prima delle recenti modifiche **i blocchi di domini e indirizzi IP erano permanenti**, cioè una volta inseriti non era prevista una procedura per sbloccarli, nemmeno dopo che i domini non esistevano più.

Per i domini in realtà nella maggior parte dei casi questa limitazione non crea problemi (al di là del fatto che in poco più di sei mesi sono stati accumulati circa **18mila domini bloccati**, un numero che rischia di diventare molto grande e difficile da trattare in modo efficiente), ma per gli indirizzi IP la storia è diversa.
...
(A lamentarsi ci sono anche varie associazioni di categoria, tra cui Asstel, che va però ricordato [sia stata](https://www.startmag.it/economia/calcio-la-pirateria-senza-freni-fa-scazzare-de-siervo-serie-a-e-sarmi-asstel/) tra le proponenti della piattaforma Piracy Shield.)
...
Il settore in cui la pirateria si è ridotta maggiormente è quello della musica, dove è stata stimata una riduzione degli accessi illegali dell'81% nello stesso periodo.
...
>
> Come risolvere dunque il problema? Probabilmente si doveva pensare ad un altro modello di business, non incentrato solamente sui diritti televisivi italiani, ma anche sulla vendita dei diritti all'estero. Questo avrebbe consentito, come accaduto per esempio in Premier, di far aumentare in maniera notevole il giro d'affari.
>
> Di questo probabilmente ne avrebbero giovato tutti, con maggiori introiti per i club, e prezzi più accessibili ai tifosi che al momento hanno sulle spalle anche il sostentamento dei club, attraverso gli abbonamenti TV.
...
*Grazie a x per aver revisionato questo articolo e a Andy Maxwell di TorrentFreak per il gentile aiuto nel lavoro di ricerca per la scrittura di questo articolo.*

*Sponsor moment: se hai un'azienda e invii tante email dai un'occhiata al mio servizio di monitoraggio [DMARCwise](https://dmarcwise.io) (almeno non era un popup a schermo intero, dai).*
