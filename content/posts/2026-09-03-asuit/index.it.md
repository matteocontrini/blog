...
In ogni momento dovrebbe invece esserci una roadmap che stabilisca “cosa facciamo nei prossimi tre mesi per semplificare la vita delle persone”, che sia il personale sanitario o i cittadini. Fare questo dipendendo da bandi e fornitori completamente disallineati con la missione (la Accenture di turno ritiene un progetto completato con successo una volta spuntate tutte le checkbox; ha ragione perché c'è scritto così nel contratto, ma è un approccio lontanissimo dal mettere al centro le persone nella progettazione e sviluppo dei servizi) è **garanzia di fallimento**.
